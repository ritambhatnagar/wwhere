...
class CI_DB_active_record extends CI_DB_driver {
    ...
    function _create_single_alias_from_table($item) {
        return 'single_col';
    }

    function _create_combo_alias_from_table($inc = '') {
        return 'combo' . $inc;
    }
     ...
     * @return	object
     */
    function select_single($table = '', $col = '', $limit = null, $offset = null) {
        ...
        if ($alias == '') {
            $alias = $this->_create_single_alias_from_table(trim($col));
        }

        $sql = $this->_protect_identifiers(trim($col)) . ' AS ' . $alias;
     ...
     * @return	object
     */
    function select_combo($table = '', $col1 = '', $col2 = '', $limit = null, $offset = null, $where_condition = "1=1", $order_by = "") {
        ...
        $alias = $this->_create_combo_alias_from_table(1);
        $sql = $this->_protect_identifiers(trim($col1)) . ' AS ' . $alias;
        $this->ar_select[] = $sql;

        $alias = $this->_create_combo_alias_from_table(2);
        $sql = $this->_protect_identifiers(trim($col2)) . ' AS ' . $alias;
        $this->ar_select[] = $sql;
    ...
    function select_assoc($table = '', $assoc_field = '', $limit = null, $offset = null) {
        if (!is_string($table) OR $table == '') {
            $this->display_error('db_invalid_query');
        }
        $sql = $table;
